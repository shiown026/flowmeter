...
serfm = serial.Serial('/dev/tty.usbserial-FT9LHTS7',115200,timeout=1)    # make sure this is the table with DMF (I initialize it with water table for raw readings)
...
while(1):
    ...
    cmd = "echo "+str(t)+"," + str(x) + " >> flowlog_mass_20241023.csv"   # This is the log file name
    # cmd = "echo "+str(t)+"," + str(x) + "," + str(x2) + " >> flowlog_mass_20240702_Tandem_flom_meter_meas_02.csv"   # This is the log file name
    os.system(cmd)
